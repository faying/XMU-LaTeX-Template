...
\def\mainmatter{\fancypagestyle{plain}{}
    \pagestyle{fancy}
    \fancyhf{}   
    \fancyhead[CE,CO]{\song\wuhao\leftmark}
...
%中文封面%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    ...
    \begin{figure}[htb!]
        \centering
        \includegraphics[width=6.2cm,bb=0 0 200 58]{figure/xmulogo.jpg}
    \end{figure}
    ...
    \parbox[t][0.5cm][c]{\textwidth}{\xiaoer\kai
